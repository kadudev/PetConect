...
<header id="header" class="header">
    ...
    <form action="logar.php" method="post" class="Login" id="Login">
          <h1>LOGIN</h1>
          <br>
          <input type="text" placeholder="Email ou nome de usuário" name="emailouusuario" required>
          <br><br>
          <input type="password" placeholder="Senha" name="senha" required>
          <br><br>
          <div class="ec">
          <input type="submit" value="ENTRAR" id="acesso" name="submit">
          <a href="cadastrar.php" >CADASTRAR</a> <!--ajustar isso aq-->
          </div>
        </form>
